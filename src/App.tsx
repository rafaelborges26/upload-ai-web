    ...
    <div className='min-h-screen flex flex-col'>
      ...
      <main className='flex-1 p-6 flex gap-6'>
        ...
        >
          ...
          <label htmlFor="video" className='border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col items-center justify-center text-muted-foreground hover:bg-primary/5'>
          ...
          <div className='space-y-2'>
            ...
            <Textarea id="transcription_prompt" className='h-20 leading-relaxed resize-none' placeholder='Inclua palavras-chave mencionadas no vídeo separadas por (,)' />
          </div>
